...
class DrawPoints:
    ...
    def grid_hide(self):
        ...
        self.dlg.grid_lenght.setValue(0)
        ...
        self.dlg.grid_coords_of_left_bottom_corner_x.setValue(0)
        self.dlg.grid_coords_of_left_bottom_corner_y.hide()
        self.dlg.grid_coords_of_left_bottom_corner_y.setValue(0)
    ...
    def grid_show(self):
        ...
        self.dlg.grid_coords_of_left_bottom_corner_label_x.show()
        self.dlg.grid_coords_of_left_bottom_corner_label_y.show()
        self.dlg.grid_coords_of_left_bottom_corner_x.show()
        self.dlg.grid_coords_of_left_bottom_corner_y.show()
        self.dlg.grid_frame.show()

    def gridslope_hide(self):
        self.dlg.gridslope_height_label.hide()
        self.dlg.gridslope_height.hide()
        self.dlg.gridslope_height.setValue(0)
        self.dlg.gridslope_lenght_label.hide()
        self.dlg.gridslope_lenght.hide()
        self.dlg.gridslope_lenght.setValue(0)
        self.dlg.gridslope_vertical_lines_amount_label.hide()
        self.dlg.gridslope_vertical_lines_amount.hide()
        self.dlg.gridslope_vertical_lines_amount.setValue(0)
        self.dlg.gridslope_horizontal_lines_amount_label.hide()
        self.dlg.gridslope_horizontal_lines_amount.hide()
        self.dlg.gridslope_horizontal_lines_amount.setValue(0)
        ...
        self.dlg.gridslope_coords_of_left_bottom_corner_x.setValue(0)
        self.dlg.gridslope_coords_of_left_bottom_corner_y.hide()
        self.dlg.gridslope_coords_of_left_bottom_corner_y.setValue(0)
    ...
    def gridslope_show(self):
        ...
        self.dlg.gridslope_coords_of_left_bottom_corner_label_x.show()
        self.dlg.gridslope_coords_of_left_bottom_corner_label_y.show()
        self.dlg.gridslope_coords_of_left_bottom_corner_x.show()
        self.dlg.gridslope_coords_of_left_bottom_corner_y.show()
    ...
    def snow_hide(self):
        ...
        self.dlg.snow_coords_of_center_x.setValue(0)
        self.dlg.snow_coords_of_center_y.hide()
        self.dlg.snow_coords_of_center_y.setValue(0)
    ...
    def snow_show(self):
        ...
        self.dlg.snow_dots_amount_label.show()
        self.dlg.snow_dots_amount.show()
        self.dlg.snow_coords_of_center_label.show()
        self.dlg.snow_coords_of_center_label_x.show()
        self.dlg.snow_coords_of_center_label_y.show()
        self.dlg.snow_coords_of_center_x.show()
        self.dlg.snow_coords_of_center_y.show()
    ...
    def snowadvanced_hide(self):
        ...
        self.dlg.snowadvanced_coords_of_center_x.setValue(0)
        self.dlg.snowadvanced_coords_of_center_y.hide()
        self.dlg.snowadvanced_coords_of_center_y.setValue(0)
    ...
    def snowadvanced_show(self):
        ...
        self.dlg.snowadvanced_dots_amount_label.show()
        self.dlg.snowadvanced_dots_amount.show()
        self.dlg.snowadvanced_coords_of_center_label.show()
        self.dlg.snowadvanced_coords_of_center_label_x.show()
        self.dlg.snowadvanced_coords_of_center_label_y.show()
        self.dlg.snowadvanced_coords_of_center_x.show()
